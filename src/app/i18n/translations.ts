...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "pricing.free": "Free",
    "pricing.freePrice": "$0",
    "pricing.freeSub": "1 property · 30 photos · 3 AI/mo",
  ...
  zh: {
    ...
    "pricing.free": "免费",
    "pricing.freePrice": "$0",
    "pricing.freeSub": "1个房产 · 30张 · AI每月3次",
  ...
  es: {
    ...
    "pricing.free": "Gratis",
    "pricing.freePrice": "$0",
    "pricing.freeSub": "1 propiedad · 30 fotos · 3 IA/mes",
  ...
  de: {
    ...
    "pricing.freePrice": "$0",
    "pricing.freeSub": "1 Immobilie · 30 Fotos · 3 KI/Mon.",
